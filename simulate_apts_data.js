...
const baseUrl = process.env.APTS_BASE_URL || 'http://localhost:47301/api';
const apiKey = process.env.APTS_API_KEY || 'default-dev-key';

if (!process.env.APTS_API_KEY) {
  console.warn(`[APTS] Missing APTS_API_KEY. Checked process.env and ${expectedEnvPath}. Using fallback default-dev-key for local simulation. Run this script from the project root containing .env or export APTS_API_KEY.`);
}
