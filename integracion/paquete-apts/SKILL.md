...
5. Configura `APTS_BASE_URL` y `APTS_API_KEY` en un archivo `.env` en la raiz del proyecto cliente (o en un secret manager equivalente que las exponga como variables de entorno).
