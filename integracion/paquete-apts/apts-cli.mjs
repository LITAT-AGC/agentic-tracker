...
const COMMAND_HELP_DETAILS = {
  ...
  'read-project-context': {
    ...
    examples: [
      "node .ia/apts/apts-cli.mjs read-project-context --json '{\"limit\":5,\"view\":\"compact\"}'",
    ],
  },
  'list-backlog-items': {
    requiredFields: [],
    ...
    examples: [
      "node .ia/apts/apts-cli.mjs list-backlog-items --json '{\"status\":\"ready\",\"view\":\"compact\"}'",
    ],
  },
  'get-backlog-item': {
    requiredFields: ['backlog_item_id'],
    examples: [
      "node .ia/apts/apts-cli.mjs get-backlog-item --json '{\"backlog_item_id\":\"11111111-1111-1111-1111-111111111111\",\"view\":\"full\"}'",
    ],
  },
  'get-task': {
    requiredFields: ['task_id'],
    examples: [
      "node .ia/apts/apts-cli.mjs get-task --json '{\"task_id\":\"22222222-2222-2222-2222-222222222222\"}'",
    ],
  },
  'get-project-constraints': {
    requiredFields: [],
    ...
    examples: [
      "node .ia/apts/apts-cli.mjs get-project-constraints --json '{}'",
    ],
  },
  'search-similar-bug-reports': {
