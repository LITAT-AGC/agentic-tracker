...
const COMMAND_HELP_DETAILS = {
  'register-task': {
    ...
    examples: [
      "node .ia/apts/apts-cli.js register-task --json '{\"project_url\":\"https://github.com/org/repo\",\"title\":\"Implement feature\",\"agent_name\":\"Copilot\",\"agent_email\":\"copilot@example.com\"}'",
  ...
  'read-project-context': {
    requiredFields: ['url'],
    examples: [
      "node .ia/apts/apts-cli.js read-project-context --json '{\"url\":\"https://github.com/org/repo\",\"limit\":5}'",
    ],
  },
  'list-backlog-items': {
    requiredFields: ['url'],
    examples: [
      "node .ia/apts/apts-cli.js list-backlog-items --json '{\"url\":\"https://github.com/org/repo\",\"status\":\"ready\"}'",
    ],
  },
  'create-backlog-item': {
    requiredFields: ['project_url', 'title'],
    examples: [
      "node .ia/apts/apts-cli.js create-backlog-item --json '{\"project_url\":\"https://github.com/org/repo\",\"title\":\"Document APTS examples\"}'",
    ],
  },
  'update-backlog-item': {
  ...
  'update-task-status': {
    ...
    examples: [
      "node .ia/apts/apts-cli.js update-task-status --json '{\"task_id\":\"22222222-2222-2222-2222-222222222222\",\"status\":\"review\",\"project_url\":\"https://github.com/org/repo\",\"agent_name\":\"Copilot\",\"agent_email\":\"copilot@example.com\"}'",
    ],
  },
  'log-agent-progress': {
    requiredFields: ['task_id', 'project_url', 'agent_name', 'branch', 'message'],
    examples: [
      "node .ia/apts/apts-cli.js log-agent-progress --json '{\"task_id\":\"22222222-2222-2222-2222-222222222222\",\"project_url\":\"https://github.com/org/repo\",\"agent_name\":\"Copilot\",\"branch\":\"main\",\"message\":\"Checkpoint\"}'",
    ],
  },
  'report-blocker': {
    requiredFields: ['project_url', 'task_id', 'error_message', 'agent_name'],
    examples: [
      "node .ia/apts/apts-cli.js report-blocker --json '{\"project_url\":\"https://github.com/org/repo\",\"task_id\":\"22222222-2222-2222-2222-222222222222\",\"error_message\":\"Tests are blocked by missing fixture\",\"agent_name\":\"Copilot\"}'",
    ],
  },
  heartbeat: {
    requiredFields: ['task_id', 'agent_name', 'project_url'],
    examples: [
      "node .ia/apts/apts-cli.js heartbeat --json '{\"task_id\":\"22222222-2222-2222-2222-222222222222\",\"agent_name\":\"Copilot\",\"project_url\":\"https://github.com/org/repo\"}'",
